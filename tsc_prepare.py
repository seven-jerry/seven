...
def writeConfig():
    ...
    with open("out/tsconfig.json",'w') as f:
        f.write(content)

if os.path.exists("out"):
    shutil.rmtree('out')
if os.path.exists("in.js"):
    os.remove('in.js')
if os.path.exists("out.js"):
    os.remove('out.js')

os.makedirs("out")
findFiles("./ts/",".ts",allFiles)
...
with open("out/in.js",'r')as r:
    with open('out/out.js','w') as w:
...
shutil.copy2("out/out.js", 'out.js')
